...
<c:set var="contextPath" value="${pageContext.request.contextPath }"></c:set>
    ...
    <div id="main">
    <a href=<%if(session.getAttribute("user")!=null){ %>"cal.jsp"<%}else{%>"#" onclick="alert('로그인이 필요합니다');"<%} %>  >
    <div id="link1">
   	일정 관리
    ...
    <a href=<%if(session.getAttribute("user")!=null){ %>"diary.jsp"<%}else{%>"#" onclick="alert('로그인이 필요합니다');"<%} %> >
     <div id="link2">
        나의 하루
    ...
    <a href=<%if(session.getAttribute("user")!=null){ %>"weather.jsp"<%}else{%>"#" onclick="alert('로그인이 필요합니다');"<%} %> >
    <div id="link3">
        날씨 관리
